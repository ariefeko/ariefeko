...
**Backend Engineer · PHP · Node.js · Python · LLM Integration** based in Indonesia — Open to Worldwide B2B Contracts & Remote Roles.
...
![Platform.sh](https://img.shields.io/badge/Platform.sh-1A182A?style=flat&logo=platformdotsh&logoColor=white)
